CREATE TYPE "public"."entry_type" AS ENUM('unclassified', 'journal');--> statement-breakpoint
CREATE TYPE "public"."space_kind" AS ENUM('work', 'personal');--> statement-breakpoint
...
CREATE TABLE "entries" (
	...
	"type" "entry_type" DEFAULT 'unclassified' NOT NULL,
...
CREATE INDEX "entries_space_occurred_idx" ON "entries" USING btree ("space_id","occurred_at");--> statement-breakpoint
CREATE INDEX "entries_space_type_idx" ON "entries" USING btree ("space_id","type");--> statement-breakpoint
CREATE UNIQUE INDEX "session_token_unique" ON "session" USING btree ("token");--> statement-breakpoint
CREATE INDEX "session_user_id_idx" ON "session" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "spaces_user_kind_unique" ON "spaces" USING btree ("user_id","kind");--> statement-breakpoint
